...
function generateSchema(dataSources) {
    ...
    dataSources.forEach((source) => __awaiter(this, void 0, void 0, function* () {
        try {
            const ImportedDataSource = yield Promise.resolve().then(() => __importStar(require(source.plugin)));
